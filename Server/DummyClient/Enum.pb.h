...
template<typename T>
inline const std::string& ESkillId_Name(T enum_t_value) {
  static_assert(::std::is_same<T, ESkillId>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function ESkillId_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    ESkillId_descriptor(), enum_t_value);
}
inline bool ESkillId_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, ESkillId* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<ESkillId>(
    ESkillId_descriptor(), name, value);
}
// ===================================================================
...
template <> struct is_proto_enum< ::Protocol::ESkillId> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Protocol::ESkillId>() {
  return ::Protocol::ESkillId_descriptor();
}
